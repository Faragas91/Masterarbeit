...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.5]{D:/Masterarbeit/2.Versuch/Result/Bar Chart.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.5]{D:/Masterarbeit/2.Versuch/Result/Bar Chart Total Times.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.5]{D:/Masterarbeit/2.Versuch/Result/Boxplot.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.5]{D:/Masterarbeit/2.Versuch/Result/RNAz/RNAz_Boxplot_pvalue.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.5]{D:/Masterarbeit/2.Versuch/Result/SISSIz/Boxplot z-score.png}
    \caption{Z-Scores}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.7]{D:/Masterarbeit/2.Versuch/Data/Pipeline Diagramm.png}
    \caption{Pipeline}
\end{figure}
...
Um die Vorhersageleistung beider Tools weiter zu testen, wurden experimentell validierte Rfam-RNA-Strukturen in simulierte, zufällig generierte Genomalignments eingebettet. Diese Benchmarking-Strategie ermöglichte eine kontrollierte Leistungsbewertung unter variierenden Sequenzähnlichkeiten (Multiple Sequence Identity, MPI). Dabei zeigte sich, dass SISSIz insbesondere im Bereich mittlerer Ähnlichkeiten (60–80 % MPI) überlegen war, während R-scape bei sehr hoher Ähnlichkeit (80–95 %) etwas besser abschnitt. Beide Tools wiesen jedoch Limitationen auf, weshalb ein neues, integrierendes Vorhersagewerkzeug entwickelt wurde: ECSfinder.
