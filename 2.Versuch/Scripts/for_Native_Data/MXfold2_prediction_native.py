...
SAMPLES_PATH = "/mnt/sdc2/home/c2210542009/Masterarbeit/NativeData/"
SAMPLES_FASTA = os.path.join(SAMPLES_PATH, "SAMPLES_FASTA")
MXFOLD2_PRE_OUTPUT = os.path.join(SAMPLES_PATH, "MXfold2_PREDICTION")
NUM_THREADS = 6
...
with ThreadPoolExecutor(max_workers=NUM_THREADS) as executor:
    futures = [executor.submit(run_mxfold2, file) for file in sorted(os.listdir(SAMPLES_FASTA)) if file.endswith(".fasta")]
