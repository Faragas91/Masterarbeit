...
def createExcelData(data, count, nameOfFile, excelName):
    ...
    output_dir = "/mnt/bernhard/Masterarbeit/2.Versuch/Result/Native_Data/PETfold_Excel"
    if not os.path.exists(output_dir):
        os.makedirs(output_dir)

    print(f"Your data was succsessfully transfered to {excelName}.xlsx.")
    shutil.move(f"/mnt/bernhard/Masterarbeit/{excelName}.xlsx", f"/mnt/bernhard/Masterarbeit/2.Versuch/Native_Data/PETfold_Excel/{excelName}.xlsx")
    return count
...
def createNativeExcelData(data, count, excelName):
    ...
    output_dir = "/mnt/bernhard/Masterarbeit/2.Versuch/Native_Data/PETfold_Excel"
...
directory = "/mnt/bernhard/Masterarbeit/2.Versuch/Native_Data/PETfold_PREDICTION"
