...
SAMPLES_CLUSTAL = "/mnt/bernhard/Masterarbeit/2.Versuch/Native_Data/SAMPLES_CLUSTAL/"
...
SAMPLES_FASTA = "/mnt/bernhard/Masterarbeit/2.Versuch/Native_Data/SAMPLES_FASTA/"
...
def convertClustalToFasta(inputDir, outputDir):
    for file in os.listdir(inputDir):
        if file.endswith(".clu"):
            input_file_path = os.path.join(inputDir, file)
            output_file_path = os.path.join(outputDir, os.path.splitext(file)[0] + ".fasta")
...
convertClustalToFasta(SAMPLES_CLUSTAL, SAMPLES_FASTA)
