...
SAMPLES_BPFOLD = f"{BASE_DIR}/NativeData/TEST_SAMPLES"
BPFOLD_PRE_OUTPUT = f"{BASE_DIR}/NativeData/BPFOLD_PREDICTION"
...
files = [f for f in os.listdir(SAMPLES_BPFOLD) if f.endswith(".fa")]
