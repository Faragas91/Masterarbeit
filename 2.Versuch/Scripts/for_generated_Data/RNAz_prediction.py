...
RNAz_PRE_OUTPUT = "/home/sredl/Masterarbeit/2.Versuch/Data/RNAz/With_SISSI/RNAz_PREDICTION"
...
with ProcessPoolExecutor(max_workers=NUM_CORES) as executor:
    futures = {executor.submit(process_file_rnaz, file): file for file in os.listdir(SAMPLES) if file.endswith(".clu")}
