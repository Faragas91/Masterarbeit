...
SISSIz_PRE_OUTPUT = "/home/sredl/Masterarbeit/2.Versuch/Data/SISSIz/With_SISSI/SISSIz_PREDICTION"
...
with ProcessPoolExecutor(max_workers=NUM_CORES) as executor:
    futures = {executor.submit(process_file_sissiz, file): file for file in os.listdir(SAMPLES) if file.endswith(".clu")}
