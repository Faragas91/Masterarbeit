...
def createExcelData(data, count, nameOfFile, excelName):
    ...
    shutil.move(f"D:/Masterarbeit_programmieren/{excelName}.xlsx", f"D:/Masterarbeit_programmieren/2.Versuch/Data/MXfold2_Excel/{excelName}.xlsx") #f"C:/bla/Waste/MA/{excelName}.xlsx", f"C:/bla/Waste/MA/2.Versuch/Data/MXfold2_Excel/{excelName}.xlsx")
    return count
