...
def createExcelData(data, count, nameOfFile, excelName):
    ...
    shutil.move(f"/home/slais/Masterarbeit/Scripts/{excelName}.xlsx", f"/home/slais/Masterarbeit/Data/{excelName}.xlsx")
    return count 

directory = "/home/slais/Masterarbeit/Data/SISSIz_PREDICTION"
